...
import com.qihang.shortlink.project.dto.req.RecycleBinRecoverReqDTO;
import com.qihang.shortlink.project.dto.req.RecycleBinRemoveReqDTO;
...
import static com.qihang.shortlink.project.common.constant.RedisKeyConstant.GOTO_IS_NULL_SHORT_LINK_KEY;
import static com.qihang.shortlink.project.common.constant.RedisKeyConstant.GOTO_SHORT_LINK_KEY;
...
public class RecycleBinServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements RecycleBinService {
    ...
    public IPage<ShortLinkPageRespDTO> pageShortLink(ShortLinkRecycleBinPageReqDTO requestParam) {
        ...
        LambdaQueryWrapper<ShortLinkDO> queryWrapper = Wrappers.lambdaQuery(ShortLinkDO.class)
                ...
                .eq(ShortLinkDO::getEnableStatus, 1) // 未被启用的短链接
                .eq(ShortLinkDO::getDelFlag, 0)
